...
def run_capital_allocator(**kwargs) -> str:
...
def run_risk_review(**kwargs) -> str:
...
def run_technical_scan(**kwargs) -> str:
...
def run_fundamental_scan(**kwargs) -> str:
...
def run_sentiment_scan(**kwargs) -> str:
