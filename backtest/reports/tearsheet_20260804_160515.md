...
| **Final Portfolio Value** | **₹104,725.88** |
| **Strategy CAGR** | **0.43%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-13.91%** |
| **Annualized Sharpe Ratio** | **1.24** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.24** |
| **Maximum Drawdown** | **-19.94%** |
| **Total Trades Executed** | **199** (Win Rate: 46.15%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 117 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹1755.00
