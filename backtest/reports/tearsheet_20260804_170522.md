...
| **Final Portfolio Value** | **₹96,648.49** |
| **Strategy CAGR** | **-0.52%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.87%** |
| **Annualized Sharpe Ratio** | **1.21** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **3.89** |
| **Maximum Drawdown** | **-23.42%** |
| **Total Trades Executed** | **150** (Win Rate: 39.08%) |
