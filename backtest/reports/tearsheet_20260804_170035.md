...
> [!WARNING]
> **STATISTICAL POWER WARNING:** This simulation generated only 0 trades (minimum 30 required). The metrics below may not be statistically significant.
...
| **Alpha (vs Nifty 500)** | **-114.35%** |
| **Annualized Sharpe Ratio** | **-409461.51** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **nan** |
| **Maximum Drawdown** | **nan%** |
| **Total Trades Executed** | **0** (Win Rate: 0.0%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 0 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹0.00
