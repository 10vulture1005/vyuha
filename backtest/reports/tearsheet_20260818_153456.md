...
| **Final Portfolio Value** | **₹258,153.49** |
| **Strategy CAGR** | **11.81%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-2.54%** |
| **Annualized Sharpe Ratio** | **0.41** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **0.49** |
| **Maximum Drawdown** | **-18.59%** |
| **Total Trades Executed** | **1062** (Win Rate: 0.0%) |
