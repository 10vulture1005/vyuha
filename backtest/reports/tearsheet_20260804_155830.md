...
| **Final Portfolio Value** | **₹102,505.38** |
| **Strategy CAGR** | **0.18%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.17%** |
| **Annualized Sharpe Ratio** | **1.24** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.13** |
| **Maximum Drawdown** | **-18.18%** |
| **Total Trades Executed** | **291** (Win Rate: 65.83%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 199 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹2985.00
