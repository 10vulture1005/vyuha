...
| **Final Portfolio Value** | **₹82,106.98** |
| **Strategy CAGR** | **-2.43%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-16.78%** |
| **Annualized Sharpe Ratio** | **1.17** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **3.68** |
| **Maximum Drawdown** | **-19.32%** |
| **Total Trades Executed** | **135** (Win Rate: 0.0%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 59 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹885.00
