...
| **Final Portfolio Value** | **₹99,173.38** |
| **Strategy CAGR** | **-0.22%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.56%** |
| **Annualized Sharpe Ratio** | **1.22** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.25** |
| **Maximum Drawdown** | **-20.3%** |
| **Total Trades Executed** | **221** (Win Rate: 56.03%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 141 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹2115.00
