...
| **Final Portfolio Value** | **₹105,274.02** |
| **Strategy CAGR** | **0.49%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-13.85%** |
| **Annualized Sharpe Ratio** | **1.24** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.0** |
| **Maximum Drawdown** | **-23.96%** |
| **Total Trades Executed** | **203** (Win Rate: 37.39%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 115 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹1725.00
