...
| **Final Portfolio Value** | **₹102,311.06** |
| **Strategy CAGR** | **0.15%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.19%** |
| **Annualized Sharpe Ratio** | **1.24** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.25** |
| **Maximum Drawdown** | **-17.13%** |
| **Total Trades Executed** | **404** (Win Rate: 77.81%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 311 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹4665.00
