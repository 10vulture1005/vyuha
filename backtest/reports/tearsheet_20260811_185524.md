...
| **Final Portfolio Value** | **₹288,731.95** |
| **Strategy CAGR** | **13.31%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-1.04%** |
| **Annualized Sharpe Ratio** | **0.48** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **0.61** |
| **Maximum Drawdown** | **-23.1%** |
| **Total Trades Executed** | **545** (Win Rate: 0.0%) |
