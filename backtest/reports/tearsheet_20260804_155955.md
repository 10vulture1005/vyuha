...
| **Final Portfolio Value** | **₹98,575.23** |
| **Strategy CAGR** | **-0.29%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.63%** |
| **Annualized Sharpe Ratio** | **1.22** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.14** |
| **Maximum Drawdown** | **-20.44%** |
| **Total Trades Executed** | **165** (Win Rate: 38.46%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 91 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹1365.00
