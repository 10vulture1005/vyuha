...
| **Final Portfolio Value** | **₹102,916.59** |
| **Strategy CAGR** | **0.22%** |
| **Nifty 50 Benchmark CAGR** | **12.86%** |
| **Nifty 500 Benchmark CAGR** | **14.35%** |
| **Alpha (vs Nifty 500)** | **-14.12%** |
| **Annualized Sharpe Ratio** | **1.23** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **4.28** |
| **Maximum Drawdown** | **-19.97%** |
| **Total Trades Executed** | **218** (Win Rate: 52.27%) |
...
- **Transaction Cost Impact:** Exactly debited ₹15 flat DP charges across all 132 sell executions. Slippage of 10% of daily spread was applied.
- **Total DP Charges Deducted:** ₹1980.00
