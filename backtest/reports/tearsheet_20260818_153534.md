...
|---|---|
| **Simulation Window** | `2020-01-01` to `2023-12-31` (3.99 Years) |
| **Total SIP Contributed** | **₹48,000.00** (₹1,000/month) |
| **Final Portfolio Value** | **₹181,456.80** |
| **Strategy CAGR** | **39.53%** |
| **Nifty 50 Benchmark CAGR** | **15.6%** |
| **Nifty 500 Benchmark CAGR** | **18.44%** |
| **Alpha (vs Nifty 500)** | **21.1%** |
| **Annualized Sharpe Ratio** | **0.68** (Rf = 6.5%) |
| **Annualized Sortino Ratio**| **0.82** |
| **Maximum Drawdown** | **-15.38%** |
| **Total Trades Executed** | **469** (Win Rate: 0.0%) |
